...
const keyboardStyles = tv({
  slots: {
    ...
    kbd: [
      'group-data-focused:text-fg text-center font-sans text-current/70 capitalize forced-colors:group-data-focused:text-[HighlightText]',
      'group-data-hovered:text-fg inline-grid min-h-5 min-w-[2ch] place-content-center rounded font-sans text-[.75rem] uppercase group-data-disabled:opacity-50 group-data-focused:opacity-90',
    ],
  },
})
