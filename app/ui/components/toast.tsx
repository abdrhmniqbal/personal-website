...
import { useRequestInfo } from '@/lib/utils/request'
...
const Toast = ({ ...props }: ToasterProps) => {
  ...
  return (
    <ToasterPrimitive
      theme={requestInfo.userPrefs.theme as ToasterProps['theme']}
      ...
      icons={{
        ...
        error: <CancelCircleIcon data-slot="icon" strokeWidth={2} />,
        warning: <AlertCircleIcon data-slot="icon" strokeWidth={2} />,
        success: <CheckmarkCircle02Icon data-slot="icon" strokeWidth={2} />,
